        ...
        <form action="{{ route('admin.price-lists.update', $priceList) }}" method="POST">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control" id="start_date" 
                           name="start_date" value="{{ old('start_date', $priceList->start_date) }}" required>
                </div>
                <div class="col-md-6">
                    <label for="end_date" class="form-label">End Date</label>
                    <input type="date" class="form-control" id="end_date" 
                           name="end_date" value="{{ old('end_date', $priceList->end_date) }}" required>
                </div>
            </div>
            ...
            <div id="products-container">
                @foreach($products as $product)
                    @php
                        $priceListItem = $priceList->priceListItems->firstWhere('product_id', $product->id);
